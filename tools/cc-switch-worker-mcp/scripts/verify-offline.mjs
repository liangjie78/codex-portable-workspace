...
runStep("cleanup-check", process.execPath, [
  ...
  [
    ...
    "'cc-switch-worker-cost-controls-',",
    "'cc-switch-worker-diagnostics-',",
    "'cc-switch-worker-cancel-',",
