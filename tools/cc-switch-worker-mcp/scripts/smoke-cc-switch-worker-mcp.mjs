...
mkdirSync("cc-switch-worker-smoke", { recursive: true });
writeFileSync("cc-switch-worker-smoke/math.js", "export function add(a, b) {\n  return a + b;\n}\n");
...
send("tools/call", {
  ...
  arguments: {
    cwd: process.cwd(),
    task: "Edit cc-switch-worker-smoke/math.js and add an exported divide(a, b) function that returns a / b. Do not create docs.",
    allowed_dirs: ["cc-switch-worker-smoke"],
    timeout_ms: 300000,
  },
});
...
const file = readFileSync(resolve("cc-switch-worker-smoke/math.js"), "utf8");
